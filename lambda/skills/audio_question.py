...
def main(params: tuple):
	...
	return openai.gpt(text_prompt, model="gpt-3.5-turbo-16k", context=False, system=f"Eres una IA, responde a la pregunta BASADO EN LA SIGUIENTE INFORMACIÓN proveniente de un audio: {text}")
